...
function FileUploader({ userId, folderPath }) {
  ...
  const handleUpload = async () => {
    ...
    try {
      ...
      const response = await axios.post(
        "https://ujjwalzero7.pythonanywhere.com/api/get_presigned_url/",
        payload
      );
      ...
      await axios.post(
        "https://ujjwalzero7.pythonanywhere.com/api/create_entity/",
        createEntityPayload
      );
  ...
  return (
    <>
    <h3 style={{ marginLeft: "10px", paddingTop: "10px" }}>File Uploader</h3>
